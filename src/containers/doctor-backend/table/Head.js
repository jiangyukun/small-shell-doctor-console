  ...
  render() {
    ...
    return (
      <Head>
        ...
        <Head.Item>
          医院名称
          {!this.props.open1 && <i className="fa fa-arrow-right" title="展开医生" onClick={e => this.props.updateOpenFlag({open1: true})}></i>}
        </Head.Item>

        {this.props.open1 && <Head.Item>感染科医生</Head.Item>}
        {this.props.open1 && <Head.Item>妇产科医生</Head.Item>}
        {this.props.open1 && <Head.Item>
          儿科医生
          {this.props.open1 && <i className="fa fa-arrow-left" title="收起医生" onClick={e => this.props.updateOpenFlag({open1: false})}></i>}
        </Head.Item>}
        ...
        <Head.Item width="150px">产后8周开始日期</Head.Item>
