          ...
          this.props.list.map((patient, index) => {
            return (
              ...
              >
                ...
                <Row.Item width="150px">{patient['family_phone']}</Row.Item>
                <Row.Item>{patient['hospital_name']}</Row.Item>

                <Row.Item>{patient['infection_doctor_name'] || '-'}</Row.Item>
                ...
                <Row.Item width="150px">{patient['visit_3_baby_data_miss']}</Row.Item>
                ...
                <Row.Item width="220px">{patient['visit_4_baby_data_miss']}</Row.Item>
                ...
                <Row.Item width="230px">{patient['visit_5_baby_data_miss']}</Row.Item>
              </Row>
            )
          })
        }
