      ...
      <div className="inline-block">
        <div className="group-input" style={{marginRight: '5px'}}>
          ...
          <Form className="input-form">
            <input type="text" placeholder="输入姓名查询" onChange={e => this.searchKey1Change(e)}/>
        ...
        <div className="group-input">
          ...
          <Form className="input-form">
            <input type="text" style={{width: '140px'}} placeholder="输入手机号码或编号查询" onChange={e => this.searchKey2Change(e)}/>
            <button className="icon-search-btn" onClick={e => this.filter()}></button>
          </Form>
        </div>
      </div>
